...
@immutable
abstract class AppbarTabNavigationState {
  final Widget appbarTab;
  final int index;
  const AppbarTabNavigationState({required this.appbarTab, required this.index});
}

class AppbarTabNavigationInitial extends AppbarTabNavigationState {
  const AppbarTabNavigationInitial({required super.appbarTab, required super.index});
}

class AnnouncementSessionsTab extends AppbarTabNavigationState{
  const AnnouncementSessionsTab({required super.appbarTab, required super.index});
}
